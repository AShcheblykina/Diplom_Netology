...
### Страница "Заяки" включает в себя:
- информацию о всех претензиях в виде ленты из отдельных блоков, включающих в себя информацию о:
  - названии;
  - исполнителе;
  - этапы работы с претензией в виде статусов; 
  - дате, времени и коментариях.   
  
  На странице есть фильтрация по дате от самой ранней к самой поздней. Есть возможность отредактировать жалобу,взять в работу заявки со статусом "Открыта", сбросить или исполнить заявки со статусом "В работе", добавить коментарии в заявки со всеми статусами;
- кнопка "Меню фильтрации списка заявок" (три полоски с кружками), при нажатии осуществляет переход в раздел "Фильтрация", тут происходит поиск заявок по фильтрам, путем проставления галочки в нужных пунктах:
   - окрыта;
   - в работе;
   - выполнена;
   - отмененные;
...
- кнопка "Добавления новой заявки" (+) для осуществления перехода в раздел "Создание заявки". Создается заявка по форме с полями:
  - поле для ввода Темы,
  - поле с выбором из списка Исполнителя,
  - поле для установки даты с использованием всплывающего окна с календарем. Управление происходит как описано ранее;
  - поле для установки времени. Управление происходит как описано ранее;
